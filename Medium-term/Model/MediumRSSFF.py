...
for parquet_file in parquet_files:
    ...
    train_loader, x_train, y_train, x_train_mark, y_train_mark, label_train_lstm, label_indices_train = tslib_data_loader_medium(
    ...
    val_loader, x_val, y_val, x_val_mark, y_val_mark, label_val_lstm, label_indices_val = tslib_data_loader_medium(
    ...
    test_loader, x_test, y_test, x_test_mark, y_test_mark, label_test_lstm, label_indices_test = tslib_data_loader_medium(
