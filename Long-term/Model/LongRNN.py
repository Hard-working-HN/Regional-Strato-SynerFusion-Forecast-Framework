...
for parquet_file in parquet_files:
    ...
    train_loader, x_train, y_train, x_train_mark, y_train_mark, label_train, label_indices_train = tslib_data_loader_long(
    ...
    val_loader, x_val, y_val, x_val_mark, y_val_mark, label_val, label_indices_val = tslib_data_loader_long(
    ...
    for epoch in range(epochs):
        ...
        print(f"[{file_name}] Epoch {epoch+1}/{epochs} - RNN loss: {train_loss_sum:.8f}, val loss: {val_loss_sum:.8f}")
    ...
    for i in range(test_counties):
        ...
        for start in range(0, n - window + 1, step):
            ...
            with torch.no_grad():
                pred_full = rnn_model(x_tensor, x_mark_tensor)  
