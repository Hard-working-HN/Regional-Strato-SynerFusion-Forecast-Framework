...
for parquet_file in parquet_files:
    ...
    train_loader, x_train, y_train, x_train_mark, y_train_mark, _, _ = tslib_data_loader_long(
    ...
    val_loader, x_val, y_val, x_val_mark, y_val_mark, _, _ = tslib_data_loader_long(
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            save_dir = f"./LongGRUWeights/{file_name}"
    ...
    save_pred_dir = f"./LongPrediction/{file_name}"
